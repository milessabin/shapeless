...
trait NatLenses extends Lenses {
...
object NatLensesExamples extends NatLenses with LenseExamples with App

trait LabbeledLenses extends Lenses {
...
object LabelleddLensesExamples extends LabbeledLenses with LenseExamples with App
