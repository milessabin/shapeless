object LiftOFn {
  ...
  def liftO[In <: HList, Out <: HList, R](f :  In => R)(implicit m : Mapper[Option, Id, Out, In], lf : LeftFolder[Out, Boolean, Option]) : Out => Option[R] = 
...
object TestLiftOFn {
  ...
  def main(args : Array[String]) {
    ...
    val lf = implicitly[LeftFolder[Option[Int] :: Option[Int] :: HNil, Boolean, Option]]
    val m = implicitly[Mapper[Option, Id, Option[Int] :: Option[Int] :: HNil, Int :: Int :: HNil]]
    
//    val sumO = liftO(sum) //(lo)
//    val prdO = liftO(prd)
//
