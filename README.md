...
earlier (0.13.5) or later (0.13.7-RC2) SBT version or disable name hashing by adding,
...
shapeless is built with SBT 0.13.5 or 0.13.7-RC2 or later. SBT 0.13.6 has an [issue][namehashing] related to its new
